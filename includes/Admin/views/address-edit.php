<div class="wrap">
    <h1><?php _e( 'Edit Address', 'pixoten-addons' ); ?></h1>

    <?php if ( isset( $_GET['address-updated'] ) ) { ?>
        <div class="notice notice-success">
            <p><?php _e( 'Address has been updated successfully!', 'pixoten-addons' ); ?></p>
        </div>
    <?php } ?>
    ...
    <form action="" method="post">
        ...
        <?php submit_button( __( 'Update Address', 'pixoten-addons' ), 'primary', 'submit_address' ); ?>
    </form>
</div>